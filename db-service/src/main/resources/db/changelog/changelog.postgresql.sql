...
--changeset Jessus:1612047219146-6
...
--changeset Jessus:1612047219146-9
CREATE TABLE user_history (user_id BIGINT NOT NULL, history_id BIGINT NOT NULL, user_user_option_id BIGINT NOT NULL);

--changeset Jessus:1612047219146-10
ALTER TABLE user_history ADD CONSTRAINT uk_qs60mt4ff67ydg2sdxln0uu68 UNIQUE (history_id);

--changeset Jessus:1612047219146-11
...
--changeset Jessus:1612047219146-12
ALTER TABLE user_history ADD CONSTRAINT fklc3ia1txybvsok0c7mmg2s3up FOREIGN KEY (user_user_option_id) REFERENCES users."user" (id) ON UPDATE NO ACTION ON DELETE NO ACTION;

--changeset Jessus:1612047219146-13
